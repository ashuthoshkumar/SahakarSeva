...
import { Search, MapPin, ShieldCheck, HeartHandshake, AlertTriangle, Navigation } from 'lucide-react';
          ...
          <div className="pt-1 space-y-2">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2.5 rounded-xl bg-white text-slate-900 placeholder:text-slate-400 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-teal-400 shadow-md"
              />
            </div>
